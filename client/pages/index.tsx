...
const style = {
  ...
  divBlock: "flex justify-center items-center h-screen mt-8", // Adding a top margin of 8 units,
};
//bg-[#2D242F]
const Home: NextPage = () => {
  const [Account, setAccount] = useState<string>("");
  const [CPAMMContract, setCPAMMContract] = useState<ethers.Contract | null>(
    null
  );

  const [ERC20_1Contract, setERC20_1Contract] =
    useState<ethers.Contract | null>(null);
  const [ERC20_2Contract, setERC20_2Contract] =
    useState<ethers.Contract | null>(null);
  ...
  useEffect(() => {
    ...
    const loadProvider = async () => {
      if (provider) {
        ...
        const ERC20_0contractAddress =
          "0x733Fd671fa49f9D043fe2E5E9e5251AE9e992e4E";
        const ERC20_1contractAddress =
          "0xf451bD175B5d4D64A8E9a46F64150a2D51836d5f";
        const CPAMM_ContractAddress =
  ...
  return (
    <div className={style.wrapper}>
      <Header
        ERC20_1Contract={ERC20_1Contract}
        ERC20_2Contract={ERC20_2Contract}
        Account={Account}
